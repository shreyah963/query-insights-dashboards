...
/**
 * Props for the ShardVisualization component
 */
export interface ShardVisualizationProps {
  shards: ShardProfile[];
...
/**
 * Props for the ProfilerQueries component
 */
export interface ProfilerQueriesProps {
